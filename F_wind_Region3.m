...
%% Implementation
global rho_air A_r V_10 V_rated CT_0 CT_10 V_hub z_hub kp3 ki3 pTpTh0 pTpOm0 pTpV pQpU0 dtheta
% Find V_rel
V_rel = V_hub(tindex)-dxdt_hub;
% delta_Theta
dtheta(tindex+1) = (kp3*q14 + ki3*q7);
if V_rel >= V_rated
    ...
    Fwind = 0.5*rho_air*A_r*V_10^2*CT_10 + pTpOm0*q14 - pTpV*(V_hub(tindex) - V_10) + pTpTh0*dtheta(tindex+1) + pTpV*(V_hub(tindex) - V_10);
    Tauwind = Fwind*z_hub;
    % no yaw yet!!
