function [F_Tauwind,CT_vrel] = F_wind_controller(dxdt_hub,q5,tindex)
%% Description
...
if V_rel <= V_rated
   ...
   CT_vrel = CT_0 *exp(-aCT*(V_rel-V_rated)^bCT);
   CT_hub = q5;
end
...
Fwind_t = 0.5*rho_air*A_r*CT_hub*V_rel^2;               % using the CT calculated previously using the update
